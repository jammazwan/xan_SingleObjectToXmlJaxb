...
Git clone the xan_SingleObjectToXmlJaxb project into your workspace:
...
cd xan_SingleObjectToXmlJaxb
mvn install -DskipTests

```

You man now import xan_SingleObjectToXmlJaxb into your IDE.
